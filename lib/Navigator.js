...
var Luis = require('./LuisModel');
var path = require('path');
var extend = require('extend');
var strformat = require('strformat');
var common = require('./common');
var Node = nodeAPI.Node;
var NodeType = nodeAPI.NodeType;
var List = common.List;
var conditionHandler = ConditionHandler.ConditionHandler;
var Navigator = (function () {
    ...
    Navigator.prototype.normalizeGraph = function (origGraph) {
        ...
        var _loop_1 = function(nodeId) {
            ...
            (node.scenarios || []).forEach(function (scenario) {
                ...
                var scene = new scenarioAPI.Scenario(scenario.condition, scenarioNode);
    ...
    Navigator.prototype.updateModels = function (models) {
        ...
        (models || []).forEach(function (model) {
            _this.models[model.name] = new Luis.LuisModel(model.name, model.url);
        });
    };
    return Navigator;
}());
