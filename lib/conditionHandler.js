...
(function (ConditionHandler) {
    function evaluateExpression(object, expression) {
        ...
        switch (exp.type) {
            ...
            case 'Literal':
                return exp.value;
            //added Logical Expression
	    case 'LogicalExpression':
                var lexp = exp;
                var value1 = this.evaluateExpression(object, lexp.left);
                var value2 = this.evaluateExpression(object, lexp.right);
                var b = this.calculateExpression(lexp.operator, value1, value2);
                return b;
            default:
