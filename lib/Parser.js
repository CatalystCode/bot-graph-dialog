...
var Parser = (function () {
    ...
    Parser.prototype.init = function () {
        ...
        return new Promise(function (resolve, reject) {
            _this.options.loadScenario(_this.options.scenario)
                .then(function (graph) {
                return _this.normalizeGraph(graph).then(function () {
                    return resolve();
    ...
    Parser.prototype.normalizeGraph = function (origGraph) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.recursive(graph).then(function () {
                ...
                _this.version = graph.version || _this.calculateHash(JSON.stringify(origGraph));
                return resolve();
            }).catch(function (e) { return reject(e); });
        });
    };
        ...
        if (this.isSubScenario(nodeItem)) {
            ...
            return new Promise(function (resolve, reject) {
                _this.options.loadScenario(nodeItem.subScenario)
                    ...
                    return _this.recursive(nodeItem).then(function () {
                        return resolve();
                    }).catch(function (e) { return reject(e); });
                }).catch(function (e) { return reject(e); });
            });
            ...
            _this.initNodes(node, node.steps).then(function () {
                ...
                return Promise.all(promises).then(function () {
                    if (node.type === 'sequence') {
                        return _this.initNodes(node, node.steps).then(function () {
    ...
    Parser.prototype.calculateHash = function (text) {
