...
var Parser = (function () {
    function Parser(options) {
        ...
        if (typeof options.scenariosPath === 'string' && typeof options.scenario === 'string') {
            var scenarioPath = path.join(options.scenariosPath, options.scenario);
            var scenario = Utils_1.Utils.loadJson(scenarioPath);
    ...
    Parser.prototype.initNodes = function (parent, nodes) {
        ...
        (nodes || []).forEach(function (nodeItem, index) {
            ...
            if (_this.isSubScenario(nodeItem)) {
                ...
                var subScenarioPath = path.join(_this.options.scenariosPath, nodeItem.subScenario);
                var subScenario = Utils_1.Utils.loadJson(subScenarioPath);
